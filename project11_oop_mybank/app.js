...
class Account {
    ...
    withdraw(amount) {
        if (this.balance > amount) {
            this.balance -= amount;
            console.log(`You have withdrawn ${amount}$ and Remaining balance is ${this.balance}$`);
        }
        else {
    ...
    deposit(amount) {
        this.balance += amount;
        console.log(`You Deposited ${amount}$ and your Current balance is ${this.balance}$`);
    }
    //   CHECK BALANCE
    checkBalance() {
...
class Customer {
    ...
    mobile;
    account;
    constructor(firstName, lastName, Gender, Age, phone, acc) {
...
async function service() {
    do {
        ...
        const customer = customers.find((customers) => customers.account.accNum === Number(Input.accountNumber));
        if (customer) {
            ...
            if (ans.ask === "withdraw") {
                ...
                console.log(`Your Available balance is now ${customer.account.balance}`);
            }
